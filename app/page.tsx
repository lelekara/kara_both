          ...
          <div className="grid gap-8 md:grid-cols-2 md:gap-12 items-center">
            <div className="space-y-6">
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight">
                Partagez vos souvenirs, <span className="text-orange-500">en toute simplicité</span>
              </h1>
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div className="space-y-4">
                ...
                <div className="pt-4">
                  <Link
                    href="#"
                    className="inline-flex h-10 items-center justify-center rounded-md bg-orange-500 px-4 py-2 text-sm font-medium text-white transition-colors hover:bg-orange-600 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-orange-400"
                  >
                    Essayer la démo
                  </Link>
                </div>
